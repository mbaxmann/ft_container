...
static void display_map(std::map<key, T> map) {
    typename std::map<key, T>::iterator ite_1 = map.begin();
    typename std::map<key, T>::iterator ite_2 = map.end();
...
int std_map(void)
{
    ...
    std::map<int, std::string> map_1(map_2);
    ...
    map_1.insert(std::make_pair(4, "Coucou"));
    map_1.insert(std::make_pair(5, "42"));
    map_1.insert(std::make_pair(6, "YIYIIYIYYII"));
    map_1.insert(std::make_pair(7, "?.?"));
    ...
    std::map<int, std::string>::reverse_iterator ite_1 = map_1.rbegin();
    std::map<int, std::string>::reverse_iterator ite_2 = map_1.rend();
    for (; ite_1 != ite_2; ite_1++)
	    std::cout << GREEN << (*ite_1).first << " " << (*ite_1).second << std::endl;
    std::cout << std::endl;
    ...
    map_1.insert(std::make_pair(4, "de nouvelle chose"));
    map_1.insert(std::make_pair(88, "pourqoi pas"));
    map_1.insert(std::make_pair(-6, "non")); 
    std::cout << CYAN << "map_2" << std::endl;
    display_map(map_2);
    std::cout << CYAN << "map_1" << std::endl;
    display_map(map_1);
    ...
    std::map<int, std::string>::iterator tmp = map_2.begin();
    tmp++;
    map_2.erase(tmp);
    display_map(map_2);
    ...
    std::map<int, std::string>::key_compare key_cp = map_1.key_comp();
    ...
    std::map<int, std::string>::value_compare value_cp = map_1.value_comp();
    std::cout << CYAN << "Comparing pair(33, ""test"") and pair(-666, ""nop"")  using the value_comp copy : ";
    std::cout << GREEN << 
    value_cp(std::make_pair(33, "test") , std::make_pair(-666, "nop")) << std::endl;
    ...
    map_2.insert(std::make_pair(39, "Nouveau"));
    map_2.insert(std::make_pair(54, "element"));
    map_2.insert(std::make_pair(60, "testing"));
    map_2.insert(std::make_pair(89, "fin"));
    display_map(map_2);
